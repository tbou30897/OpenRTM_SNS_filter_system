...
class twitter_api(OpenRTM_aist.DataFlowComponentBase):
    ...
    def twitterAPI (self):
        API_KEY = "Developer_APIKEY"
        API_KEY_SECRET = "Developer_APIKEYSECRET"
        ACCESS_TOKEN = "Developer_ACCESSTOKEN"
        ACCESS_TOKEN_SECRET = "Developer_ACCESSTOKENSECRET"
    ...
    def onActivated(self, ec_id):
        ...
        for i in range(self.count):
            outtext = (response_statuses[i-1]["text"].replace("\n","").replace("\u3000",""))
            result = ("".join(outtext))
