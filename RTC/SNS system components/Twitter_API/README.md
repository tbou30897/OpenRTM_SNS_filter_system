...
This component retrieves tweets (latest tweets) related to specified keywords from twitter.
...
<table>
  ...
  <tr>
    <td>Semantics</td>
    <td colspan="2">[‘ツイート 1’,’ ツイート 2’,’ ツイート 3’,’ ツイート 4’]<br/>↑のように検索ワードに関するツイートをリスト型で出力</td>
  </tr>
  <tr>
    <td>Unit</td>
    <td colspan="2"></td>
